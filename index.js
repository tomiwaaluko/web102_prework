...
const gameCountText = unfundedCount === 1 ? "game" : "games";
const descriptionText = `A total of $${totalRaisedFormatted} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedCount} ${gameCountText} remains unfunded. We need your help to fund these amazing games!`;
